...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gxzvi0e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gxzvi0e.containers.anotherwebservice.com/
...
```
git clone git@github.com:tsmakalagy/container-gxzvi0e.git
cd container-gxzvi0e
```
...
```
docker attach container-gxzvi0e
```
